...
Wire Wire Line
	8350 3600 8100 3600
Wire Wire Line
	12700 6600 12700 6250
Wire Wire Line
	12700 6250 13250 6250
Wire Wire Line
	13000 6800 13250 6800
Wire Wire Line
...
Injector Drivers
Text Notes 12700 4550 0    60   ~ 0
Output Relays
Text Notes 12750 5800 0    60   ~ 0
Map Sensor
Text Notes 12700 8650 0    60   ~ 0
PWM Idle Driver
...
U 1 1 4E996321
P 12750 8250
F 0 "D1" H 12750 8350 40  0000 C CNN
F 1 "DIODE" H 12750 8150 40  0000 C CNN
	1    12750 8250
	0    -1   -1   0   
$EndComp
...
U 1 1 4E9947FE
P 1150 6300
F 0 "L1" V 1100 6300 40  0000 C CNN
F 1 "INDUCTOR" V 1250 6300 40  0000 C CNN
	1    1150 6300
	1    0    0    -1  
$EndComp
...
F 2 "MXP4250A" H 13150 5250 60  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text Notes 8250 8650 0    60   ~ 0
Knock Processing
Text Notes 12700 7450 0    60   ~ 0
Flyback Control
...
F 1 "20pF" H 4600 9400 50  0000 L CNN
	1    4550 9500
	-1   0    0    1   
$EndComp
$Comp
...
F 1 "20pF" H 3950 9400 50  0000 L CNN
	1    3900 9500
	-1   0    0    1   
$EndComp
...
U 1 1 4E97E82D
P 7100 8200
F 0 "C3" H 7150 8300 50  0000 L CNN
F 1 "470pF" H 7150 8100 50  0000 L CNN
	1    7100 8200
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 4E97E79E
P 10450 7500
F 0 "C4" H 10500 7600 50  0000 L CNN
F 1 "3.3nF" H 10500 7400 50  0000 L CNN
	1    10450 7500
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 4E97E765
P 10000 7500
F 0 "R6" V 10080 7500 50  0000 C CNN
F 1 "10K" V 10000 7500 50  0000 C CNN
	1    10000 7500
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 4E97E744
P 9500 7600
F 0 "R5" V 9580 7600 50  0000 C CNN
F 1 "10K" V 9500 7600 50  0000 C CNN
	1    9500 7600
	0    1    1    0   
$EndComp
...
U 1 1 4E97D6D9
P 10150 7100
F 0 "C2" H 10200 7200 50  0000 L CNN
F 1 "CP1" H 10200 7000 50  0000 L CNN
	1    10150 7100
	0    -1   -1   0   
$EndComp
...
F 1 "TPIC8101" H 8400 7450 60  0000 C CNN
	1    8600 7950
	1    0    0    -1  
$EndComp
